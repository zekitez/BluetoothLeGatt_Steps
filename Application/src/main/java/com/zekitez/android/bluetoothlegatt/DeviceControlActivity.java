...
public class DeviceControlActivity extends Activity {
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    if (mGattCharacteristics != null) {
                        ...
                        if ((charaProp | BluetoothGattCharacteristic.PROPERTY_READ) == BluetoothGattCharacteristic.PROPERTY_READ) {
                            ...
                            Log.d(TAG, "servicesListClickListner: readCharacteristic " + characteristic.getUuid().toString());
                        }
    ...
    private final String LIST_PROP = "PROP";
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        ArrayList<HashMap<String, String>> gattServiceList = new ArrayList<HashMap<String, String>>();
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            name = SampleGattAttributes.lookupUuid(uuid, unknownServiceString);
            currentServiceData.put(LIST_NAME, name);
            currentServiceData.put(LIST_UUID, uuid);

            gattServiceList.add(currentServiceData);
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                properties = SampleGattAttributes.lookupProperties(gattCharacteristic.getProperties());
                name = SampleGattAttributes.lookupUuid(uuid, unknownCharaString);
                currentCharaData.put(LIST_NAME, name);
                currentCharaData.put(LIST_UUID, uuid);
                currentCharaData.put(LIST_PROP, properties);
                gattCharacteristicGroupData.add(currentCharaData);
                // List <BluetoothGattDescriptor> theList = gattCharacteristic.getDescriptors();
            }
        ...
        SimpleExpandableListAdapter gattServiceAdapter = new SimpleExpandableListAdapter(
                ...
                new String[]{LIST_NAME, LIST_UUID, LIST_PROP},
